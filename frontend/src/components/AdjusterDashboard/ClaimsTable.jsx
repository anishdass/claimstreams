    ...
    <div className='col-span-7 bg-slate-900 border border-slate-800 rounded-xl p-5 flex flex-col justify-between'>
      ...
      {pageData && (
        <div className='flex items-center justify-between pt-4 mt-4 border-t border-slate-800 text-xs text-slate-400'>
          <span>
            Page{" "}
            <strong className='text-slate-200'>{pageData.number + 1}</strong> of{" "}
            <strong className='text-slate-200'>{pageData.totalPages}</strong>
          </span>
          ...
          <div className='flex gap-2'>
            <button
              ...
              className='px-3 py-1.5 rounded-lg border border-slate-800 bg-slate-950 text-slate-300 hover:border-slate-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all'>
              Previous
            </button>
